...
public class Es284TestCase1{
    ...
    public void testEs284TestCase1(BrowserType browserType, String webBrowser) throws Exception {
    	...
    	this.validateGraphOpportunity_Well_1_Production_Productiion_Gas_Column();
    	...
    	this.validateGraphOpportunity_Well_1_Production_Equipment_Shovel_LargeEquipment();
    	...
    	EsiActivity.deleteMeasure(driver, "Revenue");
    	...
    	this.validateGraphDashboard_VariableOpCost_Oil_Maintenance_Column();
    	this.validateGraphDashboard_VariableOpCost_Gas_Electricity_Column();
    	this.validateGraphDashboard_VariableOpCost_Gas_Maintenance_Column();
    ...
    private void validateGraphOpportunity_Well_1_Production_Productiion_Gas_Column() throws InterruptedException, IOException
    {    	
    	//go to opportunities
    	//open opportunity
    	//apply filters
    ...
    private void validateGraphOpportunity_Well_1_Production_Equipment_Shovel_LargeEquipment() throws InterruptedException, IOException
    {   	
    	//go to opportunities
    	//open opportunity
    	//apply filters
    ...
    }//END METHOD validateGraphOpportinity_Well_1_Production_Equipment_Shovel_LargeEquipment
    ...
    private void validateGraphDashboard_VariableOpCost_Oil_Maintenance_Column() throws IOException, InterruptedException
    {	
    	//go to dashboard
    	//add new chart
    	//apply filters
    ...
    private void validateGraphDashboard_VariableOpCost_Gas_Electricity_Column() throws IOException, InterruptedException
    {
    	//go to dashboard
    	//add new chart
    	//apply filters
    ...
    private void validateGraphDashboard_VariableOpCost_Gas_Maintenance_Column() throws IOException, InterruptedException
    {	
    	//go to dashboard
    	//add new chart
    	//apply filters
    ...
    private void validateMetricDashboard_Revenue_Oil_Low() throws InterruptedException
    {
    	//go to dashboard
    	//add new metric
    	//apply filters
    ...
    private void validateMetricDashboard_Revenue_Gas_High() throws InterruptedException
    {
    	//go to dashboard
    	//add new metric
    	//apply filters
    ...
    private void validateMetricDashboard_Revenue_Gas_Low() throws InterruptedException
    {
    	//go to dashboard
    	//add new metric
    	//apply filters
    ...
    private void validateMetricDashboard_VariableOpCost_Oil_Electricity() throws InterruptedException
    {
    	//go to dashboard
    	//add new metric
    	//apply filters
    ...
    private void validateMetricDashboard_VariableOpCost_Oil_Maintenance() throws InterruptedException
    {	
    	//go to dashboard
    	//add new metric
    	//apply filters
    ...
    private void validateMetricDashboard_VariableOpCost_Gas_Electricity() throws InterruptedException
    {    	
    	//go to dashboard
    	//add new metric
    	//apply filters
    ...
    private void validateMetricDashboard_VariableOpCost_Gas_Maintenance() throws InterruptedException
    {    	
    	//go to dashboard
    	//add new metric
    	//apply filters
